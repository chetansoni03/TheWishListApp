    ...
    Scaffold(
        ...
        Column(
            ...
            WishTextField(
                ...
                onValueChanged = {newString -> viewModel.onWishTitleChanged(newString) }
            )
            ...
            WishTextField(
                ...
                onValueChanged = {newString -> viewModel.onWishDescriptionChanged(newString) }
            )

            Spacer(modifier = Modifier.height(10.dp))

            Button(onClick = {
                if(viewModel.wishTitleState.isNotEmpty() and viewModel.wishDescriptionState.isNotEmpty()){
                    if(id != 0L){
//                    UpdateWish
...
//                    Enter Field values to create a wish
                    snackMessage.value = "Enter Field values to create a wish"
                }
                scope.launch {
